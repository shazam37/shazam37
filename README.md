...
[![My Skills](https://skillicons.dev/icons?i=python,numpy,pandas,matplotlib,pytorch,tensorflow,scikitlearn,html,css,javascript,bootstrap,flask,linux,docker,mysql,git&theme=light)](https://skillicons.dev)
