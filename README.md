...
[![My Skills](https://skillicons.dev/icons?i=python,pytorch,tensorflow,scikitlearn,html,css,javascript,bootstrap,react,flask,fastapi,django,redis,nginx,rabbitmq,linux,docker,postgresql,git&theme=light)](https://skillicons.dev)
