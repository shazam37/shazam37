...
[![My Skills](https://skillicons.dev/icons?i=python,pytorch,tensorflow,scikitlearn,html,css,javascript,bootstrap,flask,django,redis,Node.js,nginx,linux,docker,postgresql,git&theme=light)](https://skillicons.dev)
